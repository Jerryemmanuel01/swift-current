        ...
        {user.userInfo.kycStatus === "Complete" ? (
          ...
          <div className="">
            <div className="div rounded-md w-full bg-[#00458549] p-3 text-primary text-xs">
              Please submit the required KYC information to verify your
              identity. Otherwise you will not be allowed to make withdrawal
            ...
            <div className="md:text-[13px] text-xs leading-5 text-textGray">
              ...
              <p className="">
                <span className="text-red-600">* </span>A residence permit is
                also an acceptable form of identification. <br />
