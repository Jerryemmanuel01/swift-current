...
const DashboardCard = ({ bg, title, Icon, disc, value, tooltip}) => {
  return (
    <div className={`w-full min-h-40 p-6 rounded-lg ${bg} text-white`}>
      ...
      <div className="mt-2 flex items-center justify-between gap-2">
        <h2 className="font-inter font-bold text-2xl tracking-wider">{value}</h2>
        <Link className="text-xs flex gap-2 items-center">
